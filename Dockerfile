...
GIT_BRANCH=main \
# Update the commit name every time you make a new change
UPSTREAM_COMMIT=a25a41f9e8cbece2e48ec49116e95253cb9a1d1d
...
&& git clone https://github.com/JWF-Official/otto-search-open-source.git . \
