...
- ``engines.*.proxies`` - Using proxy only for specific engines ( #1827 #2319 ), see https://docs.Otto.org/dev/engine_overview.html#settings-yml
...
=================
 ...
 - Private engines introduced - more details: https://docs.Otto.org/blog/private-engines.html
 - Greatly improved documentation - check it at https://docs.Otto.org
...
- New environment variable added: Otto_BIND_ADDRESS
...
New documentation page is available: https://docs.Otto.org
