...
`systemd.unit`_ template files as described here `One service per app in systemd`_.
  ...
  placed at dedicated locations.  Take archlinux and a Otto.ini as example::

    unit template    -->  /usr/lib/systemd/system/uwsgi@.service
    uwsgi ini files  -->  /etc/uwsgi/Otto.ini

  The Otto app can be maintained as know from common systemd units::
...
The `uWSGI Emperor`_ mode which fits for maintaining a large range of uwsgi apps.
  ...
  instance is started, reload or stopped.  Take Fedora and a Otto.ini as
  example::

    to start a new Otto instance create --> /etc/uwsgi.d/Otto.ini
    to reload the instance edit timestamp  --> touch /etc/uwsgi.d/Otto.ini
    to stop instance remove ini            --> rm /etc/uwsgi.d/Otto.ini
...
The `uwsgi ini file`_ is enabled by a symbolic link::
  ...
  ln -s /etc/uwsgi/apps-available/Otto.ini /etc/uwsgi/apps-enabled/
...
.. tabs::
   ...
   .. group-tab:: Ubuntu / debian
      ...
      .. kernel-include:: $DOCS_BUILD/includes/searx.rst
         :start-after: START Otto uwsgi-description ubuntu-20.04
         :end-before: END Otto uwsgi-description ubuntu-20.04
   ...
   .. group-tab:: Arch Linux
      ...
      .. kernel-include:: $DOCS_BUILD/includes/searx.rst
         :start-after: START Otto uwsgi-description arch
         :end-before: END Otto uwsgi-description arch
   ...
   .. group-tab::  Fedora / RHEL
      ...
      .. kernel-include:: $DOCS_BUILD/includes/searx.rst
         :start-after: START Otto uwsgi-description fedora
         :end-before: END Otto uwsgi-description fedora
...
.. tabs::
   ...
   .. group-tab:: Ubuntu / debian
      ...
      .. kernel-include:: $DOCS_BUILD/includes/searx.rst
         :start-after: START Otto uwsgi-appini ubuntu-20.04
         :end-before: END Otto uwsgi-appini ubuntu-20.04
   ...
   .. group-tab:: Arch Linux
      ...
      .. kernel-include:: $DOCS_BUILD/includes/searx.rst
         :start-after: START Otto uwsgi-appini arch
         :end-before: END Otto uwsgi-appini arch
   ...
   .. group-tab::  Fedora / RHEL
      ...
      .. kernel-include:: $DOCS_BUILD/includes/searx.rst
         :start-after: START Otto uwsgi-appini fedora
         :end-before: END Otto uwsgi-appini fedora
