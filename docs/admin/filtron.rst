...
Otto depends on external search services.  To avoid the abuse of these services
it is advised to limit the number of requests processed by Otto.
...
port 8888 where a Otto is being run. For a complete setup see: :ref:`nginx
Otto site`.
