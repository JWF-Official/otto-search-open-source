...
.. tabs::
  ...
  .. group-tab:: bash
    ...
    .. code-block:: sh
       ...
       # jump to Otto's working tree and install Otto into virtualenv
...
.. tabs::
  ...
  .. group-tab:: Use default settings
    ...
    .. code-block:: sh
       ...
       $ sudo -H mkdir -p \"$(dirname ${Otto_SETTINGS_PATH})\"
       $ sudo -H cp \"$SEARX_SRC/utils/templates/etc/Otto/settings.yml\" \\
                    \"${Otto_SETTINGS_PATH}\"
...
.. tabs::
  ...
  .. group-tab:: minimal setup
    ...
    .. code-block:: sh
       ...
       $ sudo -H sed -i -e \"s/ultrasecretkey/\$(openssl rand -hex 16)/g\" \"$Otto_SETTINGS_PATH\"

.. END Otto config

.. START check Otto installation
...
.. tabs::
  ...
  .. group-tab:: bash
    ...
    .. code-block:: sh
       ...
       # enable debug ..
       $ sudo -H sed -i -e \"s/debug : False/debug : True/g\" \"$Otto_SETTINGS_PATH\"

       # start webapp
       $ sudo -H -u ${SERVICE_USER} -i
       (${SERVICE_USER})$ cd ${SEARX_SRC}
       (${SERVICE_USER})$ export Otto_SETTINGS_PATH=\"${Otto_SETTINGS_PATH}\"
       (${SERVICE_USER})$ python searx/webapp.py

       # disable debug
       $ sudo -H sed -i -e \"s/debug : True/debug : False/g\" \"$Otto_SETTINGS_PATH\"
