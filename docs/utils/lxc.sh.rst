...
containers, what we call the: *lxc suite*.  The *Otto suite*
...
To make use of the containers from the *Otto suite*, you have to build the
...
To install the complete :ref:`Otto suite (includes searx, morty & filtron)
<lxc-searx.env>` into all LXC_ use::

  $ sudo -H ./utils/lxc.sh install suite

The command above installs a Otto suite (see :ref:`installation scripts`).  To
...
Setup Otto buildhost
=======================

You can **install the Otto buildhost environment** into one or all containers.
