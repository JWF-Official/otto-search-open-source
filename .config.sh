...
# The setup of the Otto instance is done in the settings.yml
# (Otto_SETTINGS_PATH).  Read the remarks in [1] carefully and don't forget to
# rebuild instance's environment (make buildenv) if needed.  The settings.yml
# file of an already installed instance is shown by::
#
#     $ ./utils/searx.sh --help
#     ---- Otto instance setup (already installed)
#       Otto_SETTINGS_PATH : /etc/Otto/settings.yml
#       SEARX_SRC             : /usr/local/searx/searx-src
#
# [1] https://docs.Otto.org/admin/engines/settings.html
